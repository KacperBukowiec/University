#lang racket
;;Oddaje niestety tylko zadanie 1
;;Używałem informacji z wykładów i internetu(repetytoria za bardzo mi nie pomogły)
...
(define (resolve c1 c2)
  (let* ([check1 (pos-neg? (cadr c1) (caddr c2))]
         [check2 (pos-neg? (cadr c2) (caddr c1))]) 
  (if (car check1)
      (res-clause (remove (cadr check1) (merge-vars (cadr c1) (cadr c2))) (remove (cadr check1) (merge-vars (cadr c1) (cadr c2))) (proof-res (cadr check1) (caddr c2) (cadr c1)))
      (if (car check2)
          (res-clause (remove (cadr check2) (merge-vars (cadr c1) (cadr c2))) (remove (cadr check1) (merge-vars (cadr c1) (cadr c2))) (proof-res (cadr check1) (cadr c2) (caddr c1)))
          false))))
  ;; TODO: zaimplementuj!))
...
(define c2 (res-clause (list 'q 's) (list 'p 'r) 'axiom))
(resolve c1 c2)