  ...
  '(
    ...
    (while (> k 1)
           (
            ...
            (if (= 1 (mod aexp n)) (k := k) (composite := true))
            (k := (- k 1))
            (nh := n)
            )))
...
(probably-prime? 4 20)
(probably-prime? 9 20)
(probably-prime? 45 20)
(probably-prime? 86 20)
(probably-prime? 17 20)
(probably-prime? 11 20)
(probably-prime? 97 20)
(probably-prime? 79 20)
(probably-prime? 71 20)
